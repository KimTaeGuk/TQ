	$(document).ready(function(){
		$("#pw").on('keyup', function(){equal_pw();});		// keyup_function
		$("#confirm_pw").on('keyup', function(){equal_pw();});		// keyup_function	
	...
	function equal_pw(){
			...
			var cf_pw=document.getElementById("confirm_pw").value;
			
			if(pw==""){
				document.getElementById("chkpw_div").innerHTML="작성";
			}	else {
				//비밀번호가 서로 일치할 시에 일치, 아닐 시에는 불일치
				if(pw==cf_pw){
					document.getElementById("chkpw_div").innerHTML="일치";
					eq_pw=true;
				}
				else {
					document.getElementById("chkpw_div").innerHTML="불일치";				
					eq_pw=false;
				}
			}
	}
